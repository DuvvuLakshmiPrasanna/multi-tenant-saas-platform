    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-teal-600 text-white px-5 py-2.5 rounded-lg hover:bg-teal-700 transition shadow-sm font-medium btn-primary"
        >
          {showForm ? (
            "Cancel"
          ) : (
      ...
      {/* Create Form */}
      {showForm && (
        <div className="app-card p-6 rounded-xl animate-fade-in-down">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-lg">
            <div>
              ...
              <input
                className="w-full border border-gray-300 px-4 py-2 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => (
          ...
          >
            <div className="app-card p-6 rounded-xl hover:shadow-md hover:border-teal-200 transition-all duration-200 h-full flex flex-col relative">
