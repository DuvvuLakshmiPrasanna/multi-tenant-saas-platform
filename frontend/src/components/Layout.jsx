    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 fixed h-full z-10">
        <div className="p-6 border-b border-gray-100 flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-gray-800">SaaS Manager</span>
        </div>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-20 px-4 py-3 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-800">SaaS Manager</span>
        </div>
        <button
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div
            className="bg-white w-64 h-full pt-20 p-4 shadow-xl"
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 pt-20 md:pt-8 w-full overflow-x-hidden">
        <div className="max-w-7xl mx-auto app-container">
          <Outlet />
        </div>
      </main>
    </div>
